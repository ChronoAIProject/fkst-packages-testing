...
4. For absent state, check freshness and persist `effect-intent` before the Browser effect.
5. Persist the closed Browser effect receipt before deriving canonical facts.
