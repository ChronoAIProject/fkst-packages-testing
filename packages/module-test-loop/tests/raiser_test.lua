...
return {
  test_seam_keepalive_trace = function()
    ...
    t.eq(trace.source_payload.raiser, "module-test-loop.seam_keepalive")
    t.eq(trace.routed_to[1], "module-test-loop.seam")
...
return {
  test_seam_keepalive_cron_shape = function()
    ...
    t.eq(raiser.produces, "module_loop_keepalive_tick")
  end,
}
