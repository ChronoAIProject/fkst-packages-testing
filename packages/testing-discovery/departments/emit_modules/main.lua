...
local M = saga.department(spec, { accept = is_discovery_result, done = done, act = act, wrap = workflow_logging.wrap_pipeline_failure, name = "testing-discovery.emit_modules" })
