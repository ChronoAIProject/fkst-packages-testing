...
return {
  test_seam_keepalive_trace = function()
    ...
    t.eq(trace.source_payload.raiser, "online-regression.seam_keepalive")
    t.eq(trace.routed_to[1], "online-regression.seam")
...
return {
  ...
  test_seam_keepalive_cron_shape = function()
    ...
    t.eq(raiser.produces, "online_regression_keepalive_tick")
  end,
}
