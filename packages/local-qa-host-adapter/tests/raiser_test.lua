...
return {
  test_seam_keepalive_trace = function()
    ...
    t.eq(trace.source_payload.raiser, "local-qa-host-adapter.seam_keepalive")
    t.eq(trace.routed_to[1], "local-qa-host-adapter.seam")
...
return {
  test_seam_keepalive_cron_shape = function()
    ...
    t.eq(raiser.produces, "local_qa_host_tick")
  end,
}
