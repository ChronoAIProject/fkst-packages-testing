...
return {
  test_seam_keepalive_trace = function()
    ...
    t.eq(trace.source_payload.raiser, "ornn-testing-profile.seam_keepalive")
    t.eq(trace.routed_to[1], "ornn-testing-profile.seam")
...
return {
  test_seam_keepalive_cron_shape = function()
    ...
    t.eq(raiser.produces, "ornn_profile_keepalive_tick")
  end,
}
